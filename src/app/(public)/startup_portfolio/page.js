...
export default function StartupPortfolio() {
  return (
    <div className="flex flex-col items-center justify-center md:gap-12 gap-6 w-full max-w-screen md:py-10">
        {/* TITLE */}
        <section className="mt-[3rem] md:mt-[6rem] w-full max-w-[60rem] md:px-8 px-4">
        ...
        <section className="flex flex-col gap-6 md:gap-12 md:mt-[5rem] sm:pt-6 px-5 sm:p-2 w-full max-w-[75rem]">
