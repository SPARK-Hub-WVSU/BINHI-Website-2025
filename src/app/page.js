      ...
      <div className="">
        ...
        <section className="relative ">
          ...
          >
            ...
            <div className="max-w-200 mt-20 md:mt-30 flex flex-col justify-between items-center">
        ...
        <section className="relative bg-blue-300">
          ...
          <div className="relative z-10 h-353">
            ...
            <h2 className="relative pt-55 z-10 max-w-187 font-bold text-5xl text-primary mx-auto text-center
            mb-12">
              We also provide these starters for your startup:
            </h2>

            <section className="mx-auto max-w-287 flex flex-wrap justify-center
            ">
