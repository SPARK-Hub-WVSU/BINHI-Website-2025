      ...
      <div className="mb-12">
        ...
        {topStories.length === 0 ? (
          <div className="text-center py-12 bg-background rounded-xl border-2 border-dashed border-secondary-neutral-light">
            ...
            <h3 className="text-sm font-medium text-foreground mb-1">No top stories</h3>
      ...
      <div>
        ...
        {allArticles.length === 0 ? (
          <div className="text-center py-12 bg-background rounded-xl border-2 border-dashed border-secondary-neutral-light">
            ...
            <h3 className="text-sm font-medium text-foreground mb-1">No articles found</h3>
            <p className="text-sm text-muted mb-4">Get started by creating your first article</p>
            <Link
              href="/cms/news/new"
