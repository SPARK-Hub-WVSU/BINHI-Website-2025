...
export default function LinkButton({
    ...
    const baseClasses = `h-fit py-3 px-6 md:py-5 md:px-7 flex-shrink-0 
    rounded-3xl md:rounded-[3rem] bg-primary text-white
    flex items-center justify-center text-base md:text-2xl font-bold
    transition-all duration-200 hover:bg-primary-dark hover:scale-105 hover:shadow-lg group`;
